...
parser.add_argument('--res_dir', type=str, help='Model output directory')
...
input_dir = args.res_dir#detection directory goes here
gt_dir = '/data/wujingjing/data/totaltext/gts/Test_mat/' #gt directory goes here
fid_path = args.exp_name+"/record.txt" #output text file directory goes here
print(input_dir,gt_dir,fid_path)
...
temp = ('Precision:_%s_______/Recall:_%s__________/hmean:_%s\n' %(str(precision), str(recall),str(f_score)))
fid.write(temp)
fid.close()
print(temp)
