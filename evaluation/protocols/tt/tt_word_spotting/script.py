...
def default_evaluation_params():
    ...
    word_spotting = "False"#"True"#p.get('word_spotting', "FALSE")
    print(word_spotting)
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    def transcription_match(transGt, transDet, specialCharacters='!?.:,*"()·[]/\'',
        ...
        if onlyRemoveFirstLastCharacterGT:
            ...
            if len(transGt) > 0 and specialCharacters.find(transGt[0]) > -1 and specialCharacters.find(
                    transGt[-1]) > -1:
                        ...
                        if gtRectMat[gtNum] == 0 and detRectMat[
                            ...
                            if iouMat[gtNum, detNum] > evaluationParams['IOU_CONSTRAINT']:
                                ...
                                if evaluationParams['WORD_SPOTTING']:
                                    ...
                                    # print(gtTrans[gtNum].lower(), detTrans[detNum].lower())
                                else:
    ...
    print(matchedSum_spot,matchedSum_det,1-matchedSum_spot/matchedSum_det)
...
if __name__ == '__main__':
    p = {}
    p['g'] = "/data/wujingjing/data/totaltext/gts/total-text-gt.zip"  # "gt.zip"
    p['s'] = "/data/wujingjing/2023_05/srsts/output/tt/submit.zip"
