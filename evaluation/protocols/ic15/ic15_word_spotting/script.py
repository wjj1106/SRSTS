...
def validate_data(gtFilePath, submFilePath, evaluationParams):
    ...
    """
    #gt = rrc_evaluation_funcs.load_file(gtFilePath, evaluationParams['GT_SAMPLE_NAME_2_ID'])
    #subm = rrc_evaluation_funcs.load_file(submFilePath, evaluationParams['DET_SAMPLE_NAME_2_ID'], True)
...
if __name__=='__main__':
    p = {}
    p['g'] = "gt.zip"#"/data/wujingjing/icdar2015/train_gts/gt.zip"#"gt.zip"
    p['s'] ="/data/wujingjing/result_rec_only/15_c2_6/submit.zip"
