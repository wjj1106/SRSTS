...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
                    ...
                    for detNum in range(len(detPols)):
                        if gtRectMat[gtNum] == 0 and detRectMat[detNum] == 0 and gtNum not in gtDontCarePolsNum and detNum not in detDontCarePolsNum :
                            if iouMat[gtNum,detNum]>evaluationParams['IOU_CONSTRAINT']:
                                ...
                                #print(gtTrans[gtNum],detTrans[detNum],correct)
                                if correct:
    ...
    print(matchedSum,matchedSum_det,1-matchedSum/matchedSum_det)
...
def text_eval_main():
    ...
    WORD_SPOTTING = False
    p = {}
    gt_file = "/data/wujingjing/data/ctw1500/gt_ctw1500.zip"  # "gt.zip"
    det_file = "/data/wujingjing/share_mask_43/output/res_save_ctw_30/69_30_p_0_38000.pth_0.8_0.4_0.7_False/448/submit.zip"
    p['g'] = "/data/wujingjing/data/ctw1500/gt_ctw1500.zip"  # "gt.zip"
    p['s'] = "/data/wujingjing/SRSTS/output/res_save_ctw_1/p_srsts_sampling_deformable_6_sa_4_ctw.pth________0.8_0.4_0.68_False/null/704/submit.zip"
